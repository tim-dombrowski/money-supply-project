...
* The [rmarkdown package](https://cran.r-project.org/package=rmarkdown) is used to generate this R Notebook, along with the [stringi](https://cran.r-project.org/package=stringi and [stringr](https://cran.r-project.org/package=stringr) packages for some additional string manipulation functionality.
